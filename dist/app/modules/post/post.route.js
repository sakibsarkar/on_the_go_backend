...
router.get("/get", auth_1.isAuthenticatedUser, post_controller_1.postController.getAllPosts);
router.get("/get/profile/:userId", auth_1.isAuthenticatedUser, post_controller_1.postController.getUserProfilePostByUserId);
router.get("/get/:id", auth_1.isAuthenticatedUser, post_controller_1.postController.getPostById);
